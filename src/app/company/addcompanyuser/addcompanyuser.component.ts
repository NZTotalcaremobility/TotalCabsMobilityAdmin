...
@Component({
  selector: 'app-addcompanyuser',
  templateUrl: './addcompanyuser.component.html',
  styleUrls: ['./addcompanyuser.component.scss']
})
export class AddcompanyuserComponent implements OnInit {
  ...
  submitForm() {
    if (this.userFormTab1.valid && this.userFormTab2.valid) {
      ...
      this.service.addCompanyUser(formModel).subscribe(res => {
