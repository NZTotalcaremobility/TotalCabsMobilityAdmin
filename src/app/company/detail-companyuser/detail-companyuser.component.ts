...
@Component({
  selector: 'app-detail-companyuser',
  templateUrl: './detail-companyuser.component.html',
  styleUrls: ['./detail-companyuser.component.scss']
})
export class DetailCompanyuserComponent implements OnInit {
